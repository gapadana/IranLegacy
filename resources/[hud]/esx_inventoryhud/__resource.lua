...
files {
  ...
  -- ICONS
    ...
    'html/img/items/gear.png',
    'html/img/items/glue_hq.png',
    'html/img/items/glue_lq.png',
    'html/img/items/petrol.png',
    'html/img/items/metal_spring.png',
    'html/img/items/metal_pipe.png',
    'html/img/items/metal_hq.png',
    'html/img/items/metal_blade.png',
    'html/img/items/leather.png',
    'html/img/items/petrol_raffin.png',
    'html/img/items/rifle_body.png',
    'html/img/items/semi_body.png',
    'html/img/items/sewingkit.png',
    'html/img/items/metal_sheet.png',
    'html/img/items/clothe.png',
    'html/img/items/smg_body.png',
