...
AddEventHandler('playerConnecting', function(name, setKickReason)
	...
	playerNameLowerCase = string.lower(playerName)
	if string.match(playerNameLowerCase, "script") or string.match(playerNameLowerCase, "<") or string.match(playerNameLowerCase, ">")then
		setKickReason("Call support")
		CancelEvent()
	end
...
AddEventHandler('es:firstJoinProper', function()
	...
	Citizen.CreateThread(function()
		...
		if not id then
			...
			playerNameLowerCase = string.lower(playerName)
			if string.match(playerNameLowerCase, "script") or string.match(playerNameLowerCase, "<") or string.match(playerNameLowerCase, ">")then
				DropPlayer(Source, "Name is not allowed")
			else
