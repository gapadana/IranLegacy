...
AddEventHandler('onMySQLReady', function ()
  ...
  MySQL.Async.fetchAll('SELECT * FROM gang', {}, function(gangs)
...
--Set Gang Command (Put Player ID | Gang | Gang Grade)
TriggerEvent('es:addGroupCommand', 'setgang', 'superadmin', function(source, args, user)
  local player = args[1]
  local gang = args[2]
  local grade = args[3]
